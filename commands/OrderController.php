            ...
            foreach ($users as $user) {
                ...
                foreach ($orders as $order) {
                    ...
                    Order::add([
                        ...
                        'operation' => 'buy',
                        'required_trading_rate' => round((100 * $order->required_trading_rate) / (100 + $order->line->step_down), $pair->price_precision),
                    ], '');
                    ...
                    Order::add([
                        ...
                        'operation' => 'sell',
                        'required_trading_rate' => round((1 + ($order->line->step_up / 100)) * $order->required_trading_rate, $pair->price_precision),
                    ], '');
